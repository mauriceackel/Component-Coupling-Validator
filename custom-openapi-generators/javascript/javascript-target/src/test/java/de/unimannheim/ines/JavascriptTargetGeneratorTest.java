 ...
 * 1) Set a break point in JavascriptTargetGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class JavascriptTargetGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("javascript-target") // use this codegen library
              ...
              .setOutputDir("out/javascript-target"); // output directory
