 ...
 * 1) Set a break point in JavascriptAdapterGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class JavascriptAdapterGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("javascript-adapter") // use this codegen library
              ...
              .setOutputDir("out/javascript-adapter"); // output directory
